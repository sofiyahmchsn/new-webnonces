      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="?page=dashboard">Home</a> 
            <span class="mx-2 mb-0">/</span> <strong class="text-black">My Profile</strong>
            <span class="mx-2 mb-0">/</span> <strong class="text-black">Edit Profile</strong>
          </div>
        </div>
      </div>
    </div> 
              ...
              <div class="p-3 p-lg-5 border">
                ...
                <div class="form-group row">
                  <div class="col-md-12">
                    ...
                    <input type="text" class="form-control" id="c_subject" name="c_subject" value="1234567">
                  </div>
                </div>
                <div class="form-group row">
                  <div class="col-lg-3">
